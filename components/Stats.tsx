...
const stats = [
  { n: '3+', d: 'Years building with React & full-stack engineering', photo: true, img: '/images/bark-rings.png', alt: 'Ancient bark with growth rings — years of accumulated depth' },
